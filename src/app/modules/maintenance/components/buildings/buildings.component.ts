...
import { selectAllBuildings } from 'src/app/shared/shared-store/shared-store.selectors';
import { BuildingResponseInterface } from './../../../../shared/interfaces/buildings.interfaces';
